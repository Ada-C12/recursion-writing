...
describe "reverse_in_place" do
  ...
  it "will reverse supercalifragilisticexpialidocious" do
    string = "supercalifragilisticexpialidocious"
    
    answer = reverse_inplace(string)
    expect(answer).must_equal "suoicodilaipxecitsiligarfilacrepus"
    expect(string).must_equal "suoicodilaipxecitsiligarfilacrepus"
  end
end
